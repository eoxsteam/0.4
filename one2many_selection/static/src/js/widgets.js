odoo.define('one2many_selection.form_widgets', function (require) {
	...
	ListRenderer.include({
		...
		_updateSelection: function () {
	        ...
	        if(this.selection.length > 0){
	        	$('.button_update_to_sale_order_lines').show()
	        }else{
	        	$('.button_update_to_sale_order_lines').hide()
	        }
	...
	var One2ManySelectable = FieldOne2Many.extend({
		...
		events: {
			"click .button_update_to_sale_order_lines": "action_selected_lines",
		},
//		start: function()
//	    {
//
//	        console.log("this.el.offsetParent==================",this)
...
//	   },
		...
		{
//		    console.log("action_selected_lines====================",this.name)
			var self=this;
			...
			rpc.query({
                'model': 'sale.order',
                'method': 'update_to_sale_order_lines',
                'args': [selected_ids,this.name],
...
//		    console.log("44442222222222244444444444444442222222222222222222222222222222222222222222222")
            var self=this;
//            console.log("objectttttttttttttttttttttttttt",self)
            var ids =[];
