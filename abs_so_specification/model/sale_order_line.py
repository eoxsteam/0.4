...
class SaleOrderLine(models.Model):
    ...
    vendor_tag_number = fields.Char(string="Vendor Tag Number")
    ...
    od_min= fields.Float(string="OD(min)(SO)")
    ...
    spacers=fields.Float(string="Spacers")
    ...
    skid_bands=fields.Char(string="Skid Bands")
    detailed_instructions=fields.Text(string="Detailed Instructions")
    forklift = fields.Char(string="Forklift(SO)")
